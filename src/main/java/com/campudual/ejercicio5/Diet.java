...
import com.campudual.ejercicio5.exceptions.*;
...
public class Diet {
    ...
    public Diet(String name,Genre genre, Integer age, Integer height, Integer weight){
        if(Genre.FEMALE == genre){
    ...
    public void addFood(Food food, Integer grams) throws MaxValuedReachedException, MaxCaloriesReachedException {
